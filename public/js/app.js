...
var swup = new swup__WEBPACK_IMPORTED_MODULE_0___default.a(); // $.ajaxSetup({
//     headers: {
...
//             e.preventDefault()
//             $.post($(this).attr('action'), { email: $("#email").val(), password: $("#password").val() }, function(response) {
...
__webpack_require__(/*! C:\laragon\www\ptiteVadrouille\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\ptiteVadrouille\resources\sass\app.scss */"./resources/sass/app.scss");
